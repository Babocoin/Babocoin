...
# TestP2PConn: A peer we use to send messages to babocoind, and store responses.
...
class CompactBlocksTest(BabocoinTestFramework):
    ...
    # This test actually causes babocoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that babocoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for babocoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # babocoind will not send blocktxn responses for blocks whose height is
