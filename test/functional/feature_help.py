...
"""Verify that starting babocoin with -h works as expected."""

from test_framework.test_framework import BabocoinTestFramework
from test_framework.util import assert_equal

class HelpTest(BabocoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start babocoin with -h for help text")
        ...
        self.log.info("Start babocoin with -version for version information")
        ...
        self.log.info("Start babocoind with -fakearg to make sure it does not start")
