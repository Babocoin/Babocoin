...
class WalletTest(BabocoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 BABO from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 babo in block rewards plus fees, but
        ...
        # Send 10 BABO with subtract fee from amount
        ...
        # Sendmany 10 BABO with subtract fee from amount
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/babocoin/babocoin/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
