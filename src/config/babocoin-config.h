/* src/config/babocoin-config.h.  Generated from babocoin-config.h.in by configure.  */
/* src/config/babocoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BABOCOIN_CONFIG_H

#define BABOCOIN_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Babocoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Babocoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/babocoin/babocoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Babocoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Babocoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "babocoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://babocoincore.org/"
