    ...
    mapper(0)
{
    ...
    ui->babocoinAtStartup->setToolTip(ui->babocoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->babocoinAtStartup->setText(ui->babocoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openBabocoinConfButton->setToolTip(ui->openBabocoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new BabocoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->babocoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBabocoinConfButton_clicked()
{
