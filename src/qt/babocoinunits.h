...
#ifndef BABOCOIN_QT_BABOCOINUNITS_H
#define BABOCOIN_QT_BABOCOINUNITS_H
...
/** Babocoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BabocoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BabocoinUnits(QObject *parent);

    /** Babocoin units.
      @note Source: https://en.babocoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BABO,
...
typedef BabocoinUnits::Unit BabocoinUnit;

#endif // BABOCOIN_QT_BABOCOINUNITS_H
