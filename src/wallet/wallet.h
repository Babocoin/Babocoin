...
#ifndef BABOCOIN_WALLET_WALLET_H
#define BABOCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this babocoin node, and set to 0 for transactions that were created
...
#endif // BABOCOIN_WALLET_WALLET_H
