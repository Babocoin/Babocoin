...
#ifndef BABOCOIN_KEYSTORE_H
#define BABOCOIN_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/babocoin/bips/blob/master/bip-0013.mediawiki
