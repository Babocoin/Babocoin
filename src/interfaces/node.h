...
#ifndef BABOCOIN_INTERFACES_NODE_H
#define BABOCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a babocoin node (babocoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // BABOCOIN_INTERFACES_NODE_H
