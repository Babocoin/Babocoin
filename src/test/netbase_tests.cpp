...
{
    BOOST_CHECK(TestSplitHost("www.babocoincore.org", "www.babocoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.babocoincore.org]", "www.babocoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.babocoincore.org:80", "www.babocoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.babocoincore.org]:80", "www.babocoincore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:29724", "127.0.0.1", 29724));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:29724", "127.0.0.1", 29724));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:29724", "::ffff:127.0.0.1", 29724));
    BOOST_CHECK(TestSplitHost("[::]:29724", "::", 29724));
    BOOST_CHECK(TestSplitHost("::29724", "::29724", -1));
    BOOST_CHECK(TestSplitHost(":29724", "", 29724));
    BOOST_CHECK(TestSplitHost("[]:29724", "", 29724));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:29724", "127.0.0.1:29724"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:29724", "[::]:29724"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
