...
#ifndef BABOCOIN_TEST_SCRIPTNUM10_H
#define BABOCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Babocoin Core 0.10.0, for cross-comparison.
 */
public:
