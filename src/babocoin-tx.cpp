...
static void SetupBabocoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " babocoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  babocoin-tx [options] <hex-tx> [commands]  Update hex-encoded babocoin transaction\n" +
            "or:     babocoin-tx [options] -create [commands]   Create hex-encoded babocoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded babocoin transaction
