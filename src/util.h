 ...
 */
#ifndef BABOCOIN_UTIL_H
#define BABOCOIN_UTIL_H
...
extern const char * const BABOCOIN_CONF_FILENAME;
extern const char * const BABOCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("babocoin-%s", name);
