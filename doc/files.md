...
* babocoin.conf: contains configuration settings for babocoind or babocoin-qt
* babocoind.pid: stores the process id of babocoind while running
...
* debug.log: contains debug information and general logging generated by babocoind or babocoin-qt
