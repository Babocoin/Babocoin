...
This document provides guidelines for internationalization of the Babocoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `babocoin_en.ts` remains unchanged.
